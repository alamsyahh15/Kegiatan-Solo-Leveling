...
final String appTitle = GlobalConfiguration().get("appTitle");

class Constants {
  static final String AEO_UI = 'OYO_UI';
  static final String MAIN_DASHBOARD = "MAIN_DASHBOARD";
  ...
  static List<OyoSpecialsList> getOyoSpecials() {
    return [
      new OyoSpecialsList('assets/images/explore1.jpg', '@AEO Near You',
          'Travelling? Choose from these best stays in india'),
      new OyoSpecialsList('assets/images/explore4.jpg', 'AEO WORKSPACES',
          'Workspaces to make every moment work!'),
      new OyoSpecialsList('assets/images/explore3.jpg', 'AEO LIFE',
          'Find long-term accommodation satrting,@Rs.5999 per month'),
      new OyoSpecialsList('assets/images/explore2.jpg', 'AEO HOTEL',
          'Travelling? Choose from these best stays in india'),
      new OyoSpecialsList('assets/images/explore1.jpg', 'AEO TOTAL HOLIDAYS',
