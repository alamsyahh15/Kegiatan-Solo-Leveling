...
//
//     final requestAntarModel = requestAntarModelFromJson(jsonString);

import 'dart:convert';

RequestAntarModel requestAntarModelFromJson(String str) =>
    RequestAntarModel.fromJson(json.decode(str));

String requestAntarModelToJson(RequestAntarModel data) =>
    json.encode(data.toJson());

class RequestAntarModel {
  RequestAntarModel({
    this.data,
    this.draw,
    this.recordsTotal,
  ...
  factory RequestAntarModel.fromJson(Map<String, dynamic> json) =>
      RequestAntarModel(
        data: json["data"] == null
            ? null
            : List<AntarData>.from(
                json["data"].map((x) => AntarData.fromJson(x))),
        draw: json["draw"],
        recordsTotal:
...
class AntarData {
  ...
  factory AntarData.fromJson(Map<String, dynamic> json) => AntarData(
