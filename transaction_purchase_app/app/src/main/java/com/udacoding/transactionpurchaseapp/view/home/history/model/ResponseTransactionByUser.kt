...
data class ResponseTransactionByUser(
...
data class CustomerDetailTransaction(
...
data class UserDetailTransaction(
...
data class DataItemHistory(
	...
	val user: UserDetailTransaction? = null,
	...
	val customer: CustomerDetailTransaction? = null
)
