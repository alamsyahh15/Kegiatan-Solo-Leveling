            ...
            Container(
              ...
              child: Padding(
                ...
                child: Text(
                  " Detector",
                  style: styleTitle.copyWith(
                      color: primaryColor, fontSize: setFontSize(60)),
                ),
              ),
            ),
          ],
        ...
        return SingleChildScrollView(
          child: ConstrainedBox(
            ...
            child: IntrinsicHeight(
              child: Column(
                children: [_circleButtonScan(), _contentBody()],
              ),
            ),
          ),
        );
          ...
          child: Column(
            children: [
              ...
              Text(
                ...
                style: styleSubtitle.copyWith(fontSize: setFontSize(35)),
              ),
              SizedBox(height: 20),
              PrimaryButton(
                color: primaryColor,
  ...
  Widget _informationWidget() {
    return Column(
      ...
      children: [
        ...
        Text('''1. Tekan tombol Scan Now pada bagian atas
